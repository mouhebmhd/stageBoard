...
async function loginAsSupervisorService(email, password, role) {
    let connection;
    ...
    try {
        ...
        const searchQuery = `SELECT * FROM Supervisors WHERE supervisorEmail ='${email}'`;
...
module.exports =  loginAsSupervisorService ;
